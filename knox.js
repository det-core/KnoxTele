...
export const casesBot = async (sock, m, chatUpdate) => {
    try {
        ...
        // Reseller check: if plugin requires reseller, block normal users
        if (plugin.reseller && !m.isReseller && !m.isOwner && !m.isAdmin) {
